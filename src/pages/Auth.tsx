    ...
    try {
      if (isSignUp) {
        ...
        if (authData.user) {
          ...
          if (selectedRole === "gig_worker") {
            ...
            const { error: vendorError } = await supabase
              ...
              .insert({ user_id: authData.user.id, full_name: fullName, company_name: fullName });
        ...
        if (authData.user) {
          ...
          navigate(roleData?.role === "gig_worker" ? "/worker/dashboard" : "/vendor/dashboard", { replace: true });
        }
      }
    } catch (error: any) {
